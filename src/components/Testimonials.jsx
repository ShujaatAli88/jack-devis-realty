      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <div className="flex justify-center mb-6">
            <span className="font-heading text-3xl font-semibold text-gold italic">JD</span>
          </div>
          <p className="section-label text-gold mb-3">Client Stories</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 text-center mx-4">
                <div className="flex justify-center mb-4">
                  {Array.from({ length: t.rating }).map((_, i) => (
                    <FiStar key={i} className="w-5 h-5 text-gold" style={{ fill: '#C8A96E' }} />
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="font-body text-gold/80 text-xs">{t.role}</p>
                  </div>
                </div>
              </div>
            </SwiperSlide>
