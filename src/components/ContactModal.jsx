...
export default function ContactModal({ onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Top accent bar */}
        <div className="h-1.5 w-full bg-gradient-to-r from-navy via-[#8D2222] to-navy" />
            ...
            {submitted ? (
              ...
              >
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-5">
                  <FiSend className="w-7 h-7 text-[#796063]" />
                </div>
              ...
              <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <p className="font-body text-xs font-semibold text-[#796063] uppercase tracking-widest mb-1">
                  Get in Touch
                </p>
